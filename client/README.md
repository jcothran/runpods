...
Client server(ubuntu, plan type:basic, 1 CPU, 512 MB RAM, 10 GB disk, 500 GB bandwidth) running on [digitalocean droplet](https://www.digitalocean.com/products/droplets) docker container at $4/month.
